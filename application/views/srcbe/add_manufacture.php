			    ...
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="<?=base_url('Savemanufacture'); ?>">
                                <div class="form-group">
                                    <label for="manufacture_name">ชื่อสินค้า <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="manufacture_name" name="manufacture_name" placeholder="Ex. Windows" />
                                </div>
                                <div class="form-group">
                                    <label for="manufacture_description">รายละเอียดสินค้า <span class="text-danger">*</span></label>
                                    <?php //echo form_error('description','<small class="text-danger">','</small>'); ?>
                                    <textarea class="ckeditor" id="editor1" name="manufacture_description" rows="20"></textarea>
                                </div>
