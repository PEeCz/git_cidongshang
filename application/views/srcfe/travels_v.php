		<div class="container margin_60">
	        ...
	        <div class="main_title">
	            <h2>แหล่งท่องเที่ยว <span class="text2">Package</span> Tours</h2>
	        ...
	        <div class="row">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        ...
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_1.jpg" width="800" height="533" class="img-fluid" alt="Image">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.2s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        <a href="single_tour.html">
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_2.jpg" width="800" height="533" class="img-fluid" alt="Image">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        <a href="single_tour.html">
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_3.jpg" width="800" height="533" class="img-fluid" alt="Image">
	                        <div class="short_info">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.4s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        <a href="single_tour.html">
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_4.jpg" width="800" height="533" class="img-fluid" alt="Image">
	                        <div class="badge_save">Save<strong>30%</strong></div>
	                        <div class="short_info">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.5s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        <a href="single_tour.html">
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_14.jpg" width="800" height="533" class="img-fluid" alt="Image">
	                        <div class="short_info">
	            ...
	            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
	                <div class="tour_container">
	                    ...
	                    <div class="img_container">
	                        <a href="single_tour.html">
	                        <img src="<?=base_url(); ?>assets_fe/img/tour_box_5.jpg" width="800" height="533" class="img-fluid" alt="Image">
	                        <div class="short_info">
	        ...
	        <p class="text-center nopadding">
	            <a href="#" class="btn_1 medium"><i class="icon-eye-7"></i>ดูแพ็คเกจทั้งหมด </a>
	        </p>
	    </div><!-- End container -->